...
export const metadata = {
  ...
  description: 'Sign in to Dockeryze with your Google or GitHub account to start generating deployment blueprints.',
};
        ...
        <div className="signin-card">
          ...
          <div className="signin-header">
            ...
            <p className="signin-subtitle">
              Sign in to generate AI-powered Docker blueprints
            </p>
          </div>
          ...
          <div className="signin-providers">
            ...
            >
              <button type="submit" className="signin-provider-btn google">
            ...
            >
              <button type="submit" className="signin-provider-btn github">
          ...
          <div className="signin-divider">
            <span>Or test locally with</span>
          </div>
