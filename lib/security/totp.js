 ...
 * @param {string} appName - Issuer name shown in authenticator app (default: "Dockeryze")
 */
export async function generateTotpSecret(userEmail = 'user@dockeryze.local', appName = 'Dockeryze') {
