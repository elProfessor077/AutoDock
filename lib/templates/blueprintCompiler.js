...
function getNodeDockerfile(config) {
  ...
  if (isNextJs) {
    return `# ── AutoDock Generated Dockerfile ────────────────────────────────────────
...
const DOCKERIGNORE_CONTENT = `# ── AutoDock .dockerignore ─────────────────────────────────────────────
node_modules
npm-debug.log*
.git
.gitignore
...
function getReadmeContent(config) {
  return `# 🐳 AutoDock BLUEPRINT

This container package was automatically generated by AutoDock.
...
function compileBlueprint(config) {
  ...
  const dockerCompose = `# ── AutoDock Generated docker-compose.yml ────────────────────────────────
